...
TEST(arraystarthandler, test_09)
{
     //
     //  {...] [
     //        ^
     using namespace json2xml;
     Option O;
     ArrayStartHandler OSH(O, Event::ARRAYEND);
     TagHistory TH("json");
     PlaceLooker PL;
     PL.set_object();
     PL++;
...
TEST(arraystarthandler, test_10)
{
     //
     //  [ ...] [
     //         ^
     ...
     Instruction i1({ InstType::OPEN, {"item"} });
     ASSERT_EQ(i1, is[0]);
     Instruction i2({ InstType::AV, {"n", "6"} });
     ASSERT_EQ(i2, is[1]);
}

TEST(arraystarthandler, test_11)
{
     //
     //  {... "key" : [
     //               ^
     using namespace json2xml;
     Option O;
     ArrayStartHandler OSH(O, Event::KEY);
     TagHistory TH("json");
     PlaceLooker PL;
     PL.set_object();
     PL++;
...
TEST(arraystarthandler, test_12)
{
     //
     //  [... "key" : [
     //               ^
...
TEST(arraystarthandler, test_13)
{
     //
     //  {... : "value", [
     //                  ^
     using namespace json2xml;
     Option O;
     ArrayStartHandler OSH(O, Event::VALUE);
     TagHistory TH("json");
     PlaceLooker PL;
     PL.set_object();
     PL++;
...
TEST(arraystarthandler, test_14)
{
     //
     //  [... : "value", [
     //                  ^
