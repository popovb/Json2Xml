...
//////////////////////////////////////////////////////////////////
     ...
     private:
	  ...
	  Instructions prev_objectstart_in_object(TagHistory&,
						  const Argument) const;
	  Instructions prev_objectstart_in_array (TagHistory&,
						  const Argument) const;
	  ...
	  Instructions prev_arrayend_in_object(TagHistory&,
					       const Argument) const;
	  Instructions
...
#endif // __json2xml_KeyHandler_hpp__
